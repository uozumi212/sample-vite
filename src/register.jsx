  ...
  return (
    <>
      <div className="p-5">
        ...
        <input id="studyContent" type="text" name="studyText" value={studyText} onChange={handleChange} className="ml-4 w-8/12 border-blue-400 border-2 rounded-md" />
      </div>
      <div className="p-5">
        <label htmlFor="studyTime">学習時間</label>
        <input  type="number" id="studyTime" name="studyTime" value={studyTime} onChange={handleChange} className="ml-4 w-8/12 border-blue-400 border-2 rounded-md"/>
